...
columns = st.multiselect(
    "Countries", (df_visu.drop(columns=["year"])).columns, key="line_selector"
)
...
columns = st.multiselect(
    "Countries", (df_visu.drop(columns=["year"])).columns, key="bar_selector"
)
